...
#define STRING_CONFIG_H_AUTHOR "Peter Repukat - FLatspotSoftware" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Plywood 3D Printer"
...
#define PID_K1 0.95       // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 46.42
    #define DEFAULT_Ki 5.63
    #define DEFAULT_Kd 95.63
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 196.73
  #define DEFAULT_bedKi 33.23
  #define DEFAULT_bedKd 704.62
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 50, 50, 200, 397.5 }
...
//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 9000, 9000, 300, 20000 } // ...or, set your own edit limits
#endif
...
#define Z_CLEARANCE_FOR_HOMING  40 // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
